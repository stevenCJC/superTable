...
file.readJSON = function(filepath, options) {
  ...
  try {
	...
	throw 'Unable to parse "' + filepath + '" file (' + e.message + ').';
  }
};
...
file.write = function(filepath, contents, options) {
  ...
  try {
	...
	throw 'Unable to write "' + filepath + '" file (Error code: ' + e.code + ').';
  }
};
...
file.copy = function(srcpath, destpath, options) {
  ...
  if (process) {
    ...
    try {
	  ...
	  throw 'Error while processing "' + srcpath + '" file.';
    }
  }
...
file.delete = function(filepath, options) {
  ...
  if (!file.exists(filepath)) {
    //grunt.verbose.error();
    console.log('Cannot delete nonexistent file.');
    return false;
  }
  ...
  try {
	...
	throw 'Unable to delete "' + filepath + '" file (' + e.message + ').';
  }
};
